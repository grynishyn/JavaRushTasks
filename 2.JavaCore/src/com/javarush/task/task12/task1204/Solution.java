...
public class Solution {
    ...
    public static void printObjectType(Object o) {
        ...
        String classNameType = o.getClass().getSimpleName();
        if(classNameType.equals("Cat")){
            System.out.println("Кошка");
        }
        else if(classNameType.equals("Dog")){
            System.out.println("Собака");
        }
        else if(classNameType.equals("Bird")){
            System.out.println("Птица");
        }
        else if(classNameType.equals("Lamp")){
