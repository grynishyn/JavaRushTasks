...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        Thread firstSpecThread = new Thread (new SpecialThread());
        Thread secondSpecThread = new Thread (new SpecialThread());
        Thread thirdSpecThread = new Thread (new SpecialThread());
        Thread fourthSpecThread = new Thread (new SpecialThread());
        Thread fifthSpecThread = new Thread (new SpecialThread());
        list.add(firstSpecThread);
        list.add(secondSpecThread);
        list.add(thirdSpecThread);
        list.add(fourthSpecThread);
        list.add(fifthSpecThread);
    }
