...
public class Solution {
    ...
    public static void println(Bridge bridge){
        if(bridge instanceof WaterBridge){
            WaterBridge bridgeWater = (WaterBridge) bridge;
            System.out.println(bridgeWater.getCarsCount());
        }
        else if(bridge instanceof SuspensionBridge){
            SuspensionBridge bridgeSuspension = (SuspensionBridge) bridge;
            System.out.println(bridgeSuspension.getCarsCount());
        }
    }
}
